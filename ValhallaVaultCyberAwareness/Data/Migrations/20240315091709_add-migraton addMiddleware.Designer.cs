...
namespace ValhallaVaultCyberAwareness.Migrations
{
    ...
    [Migration("20240315091709_add-migraton addMiddleware")]
    partial class addmigratonaddMiddleware
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ValhallaVaultCyberAwareness.Models.SegmentModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            InfoText = "Bedrägerier är handlingar där en person eller grupp försöker vilseleda, lura eller bedranågon annan för personlig vinning. Det kan omfatta olika platformar samt olika metoder som exempelvisinternet, telefon, e-post och personlig interaktion.",
                            Name = "Del 1"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("ValhallaVaultCyberAwareness.Models.VisitorCounterModel", b =>
                {
                    b.Property<int>("VisitorNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VisitorNumber"));

                    b.Property<DateTime>("Date")
                        .HasColumnType("datetime2");

                    b.HasKey("VisitorNumber");
