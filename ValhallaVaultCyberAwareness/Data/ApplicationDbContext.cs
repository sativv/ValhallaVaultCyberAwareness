        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<SegmentModel>().HasData(
                new SegmentModel()
                {
                    ...
                    Name = "Del 1",
                    CategoryId = 1,
                    InfoText = "Bedrägerier är handlingar där en person eller grupp försöker vilseleda, lura eller bedra" +
                    "någon annan för personlig vinning. Det kan omfatta olika platformar samt olika metoder som exempelvis" +
                    "internet, telefon, e-post och personlig interaktion."
                ...
                new SegmentModel()
                {
                    ...
                    Name = "Del 2",
                    CategoryId = 1,
                    InfoText = "Bedrägerier kan inträffa i hemmet, genom oönskad försäljning eller stöld. " +
                    "Nätfiske är en specifik form av bedrägeri som utförs online genom e-post, meddelandeappar eller sociala medier, " +
                    "med syftet att lura offret att lämna ut personlig information."
                ...
                new SegmentModel()
                {
                    ...
                    Name = "Del 3",
                    CategoryId = 1,
                    InfoText = "Vid fakturabedrägerier är det vanligt att olika annonsföretag försöker lura småföretagare med " +
                    "påstridiga och otydliga metoder. Det sker ofta genom att de skickar ut bluffakturor. Ransomware är en form av skadlig programvara" +
                    "som krypterar filer på en organisations eller persons dator och kräver en lösensumma för att återställa tillgången till filerna."
                ...
                new SegmentModel()
                {
                    ...
                    Name = "Del 1",
                    CategoryId = 2,
                    InfoText = "Digital säkerhet handlar om att skydda datorer, nätverk, mobiltelefoner och andra digitala enheter från " +
                    "skadlig verksamhet och obehörig åtkomst. Detta är viktigt då det krävs kunskap och expertis för att kunna sydda sig själv" +
                    "och sin organisation mot cyberattacker."
                ...
                new SegmentModel()
                {
                    ...
                    Name = "Del 2",
                    CategoryId = 2,
                    InfoText = "Genom att utge sig för att vara en legitm organisation, som en bank, en regeringsbyrå eller ett företag, " +
                    "försöker bedragaren lura offret att lämna ut personlig information, som lösenord eller kreditkortsuppgifter, " +
                    "eller att utföra obehöriga transaktioner."
                ...
                new SegmentModel()
                {
                    ...
                    "Detta kan ske genom skadlig programvara eller skadlig kod så kallada virus och trojaner. Dessa termer är alla relaterade till säkerhetsrisker på digitala " +
                    "plattformar och är viktiga att förstå för att kunna skydda sig själv och sina enheter mot cyberbrott."
                ...
                new SegmentModel()
                {
                    ...
                    Name = "Del 4",
                    CategoryId = 2,
                    InfoText = "Attacker mot servrar kan orsaka allvarliga konsekvenser, inklusive förlust av data, " +
                    "otillgänglighet av tjänster, stöld av känslig information eller skadegörelse. Detta kräver robusta säkerhetsåtgärder" +
                    " för att skydda digitala system och infrastrukturer mot attacker samt behovet av att snabbt hantera incidenter när de inträffar för att minimera skadorna."
                ...
                new SegmentModel()
                {
                    ...
                    Name = "Del 1",
                    CategoryId = 3,
                    InfoText = "Cyberspionage är en form av spionage där information och data samlas in från digitala system och nätverk för " +
                    "strategiska eller ekonomiska syften. Det utförs oftast av stater, organiserade brottsliga grupper eller företag och kan " +
                    "rikta sig mot regeringar, företag eller enskilda personer."
                ...
                new SegmentModel()
                {
                    ...
                    Name = "Del 2",
                    CategoryId = 3,
                    InfoText = " Påverkanskampanjer är planerade och koordinerade aktiviteter för att påverka " +
                    "människors åsikter eller beslut, ofta genom användning av desinformation. Affärsspionage innebär att en organisation eller individ stjäl " +
                    "konfidentiell affärsinformation från ett annat företag för ekonomisk vinning eller konkurrensfördel. Dessa aktiviteter " +
                    "utgör ett allvarligt hot mot företag, organisationer och samhället som helhet."
                ...
                new SegmentModel()
                {
                    ...
                    Name = "Del 3",
                    CategoryId = 3,
                    InfoText = " För att bekämpa cyberspionage krävs samverkan mellan olika aktörer såsom underrättelsetjänster, " +
                    "myndigheter, företag och akademiska institutioner.  Genom att dela information och samarbeta kring säkerhetsåtgärder kan " +
                    "man förbättra förmågan att upptäcka, förebygga och motverka hotet från cyberspionage."
